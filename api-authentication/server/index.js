...
app.post('/api/auth/sign-in', (req, res, next) => {
  ...
  const sql = 'SELECT "username", "hashedPassword", "userId" FROM "users" WHERE "username"= $1';
  ...
  db.query(sql, params)
    .then(result => {
      ...
      argon2
        ...
        .then(isMatch => {
          if (!isMatch) {
            throw new ClientError(401, 'the username or the password is incorrect');
          }
          ...
          const clientResponse = { token, user: payload };
