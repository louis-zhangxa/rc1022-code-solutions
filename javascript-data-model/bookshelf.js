...
console.log('the author of second book is', bookshelf[1].author);
console.log('the ISBN of first book is', bookshelf[0].isbn);
console.log('the title of third book is', bookshelf[2].title);
